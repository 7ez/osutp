...
public abstract class HitObjectManagerBase : MarshalByRefObject
{
    ...
    /// <summary>
    ///     Map a difficulty value to a range, taking mods into account. This is used for mapping DifficultyApproachRate,
    ///     DifficultyOverall and DifficultyHpDrainRate to their respective timing windows.
    /// </summary>
